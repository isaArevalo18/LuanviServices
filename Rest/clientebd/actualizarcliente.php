...
if(isset($_POST["update"])){
    ...
    $parametros='$cedula';
     ...
     telefono='$telefono',email='$email',sitioweb='$sitioWeb',comentario='$comentario',genero='$genero',sexo='$sexo',tipo='cliente'
     WHERE id=$id";
     echo $query;
     $result = mysqli_query($conexion,$query);
        if(!$result) {
  ...
  background-size: cover;">
    <main class="container p-4">
       <div class="row">
        ...
        <div class="col-md-12">
          <div class="card">
      <h5 class="card-header bg bg-dark" style="color: white;">Formulario de Edicion de Clientes</h5>
      <div class="card-body" style="background-color:#B4CDCC">
      
  <form method="POST" action="actualizarcliente.php?id=<?php echo $_GET['id']; ?>">
      ...
      <div class="form-row">
          ...
          <div>
            <label class="radio-inline" style="padding:5px">
              <input type="radio" <?php if(isset($genero) && $genero=="Femenino") echo "checked";?> value="Femenino" name="genero" checked> Femenino
            </label>
            <label class="radio-inline" style="padding:5px">
          ...
          <div>
            <label class="radio-inline" style="padding:5px">
              <input type="radio" name="sexo" <?php if(isset($sexo) && $sexo=="Mujer") echo "checked";?> value="Mujer" checked>  Mujer
            </label>
            <label class="radio-inline">
