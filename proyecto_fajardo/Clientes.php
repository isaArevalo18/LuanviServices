...
<body style="background-image: url('img/cliente.jpeg');width: 100%;
  ...
  <form method="POST" action="clientebd/insertarcliente.php">
    ...
    <?php  ?>
      ...
      <?php 
       $query="SELECT id,cedula,nombre,direccion,celular,telefono,email,sitioweb,comentario,genero,sexo,tipo FROM usuario WHERE tipo='cliente'";
      ...
      <td><?php echo $row["id"]; ?></td>
       ...
       <td>
        <a href="clientebd/actualizarcliente.php?id=<?php echo $row['id']?>&accion=editar" class="btn btn-secondary"><i class="fas fa-marker"></i></a>
        <a href="clientebd/eliminarcliente.php?id=<?php echo $row['id']?>&accion=eliminar" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
      </tr>
       <?php } ?>
      </table>
    </div>
